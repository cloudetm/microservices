...
public final class MessageId extends StringValue {
    ...
    public static MessageId valueOf(final String value) {
        return new MessageId(StringUtils.trimToEmpty(value));
    }

    public static MessageId valueOf(final StringValue value) {
        return MessageId.valueOf(value.get());
    }

    public static MessageId random() {
        return MessageId.valueOf(UUID.randomUUID().toString());
    }

    public static final class XmlAdapter extends JaxbStringValueAdapter<MessageId> {
        @Override
        protected MessageId createNewInstance(final String value) {
            return MessageId.valueOf(value);
        }
    }

    public static final class JsonDeserializeAdapater extends JsonDeserializer<MessageId> {

        @Override
        public MessageId deserialize(
                final JsonParser jp,
                final DeserializationContext ctxt) throws IOException, JsonProcessingException {
            return MessageId.valueOf(jp.getValueAsString());
        }
    }

    public static final class JsonSerializeAdapter extends JsonSerializer<MessageId> {
        @Override
        public void serialize(
                final MessageId value,
