...
public final class SubscriberMessageDeliveryUri extends StringValue {
    ...
    public static SubscriberMessageDeliveryUri valueOf(final String value) {
        return new SubscriberMessageDeliveryUri(StringUtils.trimToEmpty(value));
    }

    public static SubscriberMessageDeliveryUri valueOf(final StringValue value) {
        return SubscriberMessageDeliveryUri.valueOf(value.get());
    }

    public static final class XmlAdapter extends JaxbStringValueAdapter<SubscriberMessageDeliveryUri> {
        @Override
        protected SubscriberMessageDeliveryUri createNewInstance(final String value) {
            return SubscriberMessageDeliveryUri.valueOf(value);
        }
    }

    public static final class JsonDeserializeAdapater extends JsonDeserializer<SubscriberMessageDeliveryUri> {
    ...
    public static final class JsonSerializeAdapter extends JsonSerializer<SubscriberMessageDeliveryUri> {
        @Override
        public void serialize(
                final SubscriberMessageDeliveryUri value,
