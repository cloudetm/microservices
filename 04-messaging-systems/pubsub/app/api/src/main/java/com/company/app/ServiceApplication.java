...
import com.company.app.bundles.GuiceBundleProvider;
import com.company.app.handlers.ParameterHandlerProvider;
...
public class ServiceApplication extends Application<ServiceConfiguration> {
    ...
    private BeanConfig getPublicSwagger(final Environment environment) {
        ...
        swagConfig.setTitle("app API");
        swagConfig.setDescription("app API");
        ...
        swagConfig.setContact("admin@app.com");
