...
public final class TopicId extends StringValue {
    ...
    public static TopicId valueOf(String value) {
        return new TopicId(StringUtils.trimToEmpty(value));
    }

    public static TopicId valueOf(StringValue value) {
        return TopicId.valueOf(value.get());
    }

    public static class XmlAdapter extends JaxbStringValueAdapter<TopicId> {
        @Override
        protected TopicId createNewInstance(String value) {
            return TopicId.valueOf(value);
        }
    }

    public static class JsonDeserializeAdapater extends JsonDeserializer<TopicId> {
    ...
    public static class JsonSerializeAdapter extends JsonSerializer<TopicId> {
        @Override
        public void serialize(
                final TopicId value, final JsonGenerator jgen, final SerializerProvider provider) throws
                                                                                                      IOException,
