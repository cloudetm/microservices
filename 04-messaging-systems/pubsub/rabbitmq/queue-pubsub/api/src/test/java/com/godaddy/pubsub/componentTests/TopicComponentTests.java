...
public class TopicComponentTests extends TestBase {
    ...
    public void publish_message() throws IOException {
        ...
        // use a default exchange permanent queue
        // https://www.rabbitmq.com/tutorials/tutorial-one-java.html
        receive_message_by_using_default_exchange_permanent_queue(createTopicResponse.body().getTopicId());
    ...
    private void receive_message_by_using_default_exchange_permanent_queue(TopicId topicId) throws IOException {
        ...
        channel.queueDeclare(topicId.toString(), false, false, false, null);
        ...
        channel.basicConsume(topicId.toString(), true, consumer);
    }
}
