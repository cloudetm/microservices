...
import com.godaddy.pubsub.bundles.GuiceBundleProvider;
import com.godaddy.pubsub.dataAccess.InMemoryMessageRepository;
import com.godaddy.pubsub.handlers.ParameterHandlerProvider;
import com.godaddy.pubsub.serialization.JacksonJsonMapper;
import com.godaddy.pubsub.swagger.ValueModelResolver;
...
public class ServiceApplication extends Application<ServiceConfiguration> {
    ...
    private BeanConfig getPublicSwagger(final Environment environment) {
        ...
        swagConfig.setTitle("PubSub API");
        swagConfig.setDescription("PubSub API");
        ...
        swagConfig.setContact("pubsubplatform@godaddy.com");
